...
export function registerCommands(
	...
	subscriptions.push(
		vscode.commands.registerCommand("github-issues.new", async () => {
	...
	subscriptions.push(
		vscode.commands.registerCommand(
			"github-issues.openUrl",
			async (cell: vscode.NotebookCell) => {
				const project = projectContainer.lookupProject(
					cell.document.uri,
					false,
				);
	...
	subscriptions.push(
		vscode.commands.registerCommand("github-issues.authNow", async () => {
